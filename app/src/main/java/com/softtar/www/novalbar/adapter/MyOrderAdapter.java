...
import com.softtar.www.novalbar.activities.MyOrderClientDetailActivity;
...
public class MyOrderAdapter extends RecyclerView.Adapter<MyOrderAdapter.MyViewHolder> {
    ...
    public MyOrderAdapter(Context ctx, String []data) {
        this.ctx = ctx;
        this.data = data;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.txtSeractText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ctx, MyOrderClientDetailActivity.class);
